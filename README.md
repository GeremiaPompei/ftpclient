...
#### INITIALIZER
Permette di inizializzare una stringa di connessione FTP fornando l'*url* e la *porta* del server remoto oltre a *usernam* e *password*. Il comando è 
```
I <URL> <PORT> <USERNAME> <PASSWORD>
```
#### SEND
